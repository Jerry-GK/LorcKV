...
class ColumnFamilyHandleImpl : public ColumnFamilyHandle {
 public:
  ...
  std::shared_ptr<LogicalOrderedRangeCache> GetRangeCache() const override;
...
struct SuperVersion {
  ...
  void Init(
      ...
      MemTableListVersion* new_imm, std::shared_ptr<LogicalOrderedRangeCache> new_range_cache, Version* new_current,
...
class ColumnFamilyData {
 public:
  ...
  std::shared_ptr<LogicalOrderedRangeCache> GetRangeCache() const {
 ...
 private:
  ...
  std::shared_ptr<LogicalOrderedRangeCache> range_cache_;
