...
public:
    ContRangeCacheIterator() = default;
    // No copying allowed
    ContRangeCacheIterator(const ContRangeCacheIterator&) = delete;
    void operator=(const ContRangeCacheIterator&) = delete;

    virtual ~ContRangeCacheIterator() = default;
    ...
    // Returns true if the RangeCacheIterator has more keys in the ContRange
